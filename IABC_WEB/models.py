...
class Members (models.Model):
    ...
    profile_photo =  models.FileField(upload_to='MembersSubmissions/', blank=True, null=True)
    expiry_date =  models.CharField(max_length=50, verbose_name='Expiry Date', blank=True, null=True)
...
class Awards_prof(models.Model):
    ...
    email_add = models.CharField(unique=True, max_length=50, verbose_name='Email')
...
class Checkpayment(models.Model):
    user_id = models.ForeignKey(User, unique=True, verbose_name='user_id', on_delete=models.CASCADE )
    membership_id = models.ForeignKey(Members, unique=True, verbose_name='membership_id', on_delete=models.CASCADE , null=True)
    awards_studentid = models.ForeignKey(Awards_student, verbose_name='awards_studentid', on_delete=models.CASCADE , null=True) 
    awards_profid = models.ForeignKey(Awards_prof, verbose_name='awards_profid', on_delete=models.CASCADE , null=True)      
...
class Winners(models.Model):
    ...
    windate = models.DateField(verbose_name='Winner Date', auto_now_add=True)
...
class OnlinePaymentHistory(models.Model):
    user_id = models.ForeignKey(User, verbose_name='user_id', on_delete=models.CASCADE )
    date = models.DateTimeField(verbose_name='Payment Date', auto_now_add=True)
